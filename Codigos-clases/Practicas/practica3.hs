...
1)                                      
                                          -------------------------ax    -------------------------ax
                                          ((ρ ∧ σ) => τ), ρ, σ ⊢ ρ       ((ρ ∧ σ) => τ), ρ, σ ⊢ σ
------------------------------------ax    --------------------------------------------------------∧i
((ρ ∧ σ) => τ), ρ, σ ⊢ (ρ ∧ σ) => τ       ((ρ ∧ σ) => τ), ρ, σ ⊢ (ρ ∧ σ)
------------------------------------------------------------------------=>e
((ρ ∧ σ) => τ), ρ, σ ⊢ τ
--------------------------=>i
((ρ ∧ σ) => τ), ρ ⊢ σ => τ
...
2)      
                                                    ...
                                                    (ρ => (σ => τ)), (ρ ∧ σ) ⊢ (p ∧ σ)   
----------------------------------------ax          ----------------------------------∧e1       ----------------------------------ax
(ρ => (σ => τ)), (ρ ∧ σ) ⊢ (p => σ => τ)            (ρ => (σ => τ)), (ρ ∧ σ) ⊢ p                (ρ => (σ => τ)), (ρ ∧ σ) ⊢ (ρ ∧ σ) 
----------------------------------------------------------------------------=>e                 ----------------------------------∧e2
(ρ => (σ => τ)), (ρ ∧ σ) ⊢ (σ => τ)                                                             (ρ => (σ => τ)), (ρ ∧ σ) ⊢ σ 
-----------------------------------------------------------------------------------------------------------------------------=>e
(ρ => (σ => τ)), (ρ ∧ σ) ⊢ τ 
-------------------------------=>i
(ρ => (σ => τ)) ⊢ (ρ ∧ σ) => τ 
...
1)
                              ...
                              ¬(ρ ∨ σ), ρ ⊢ ρ                                                     ¬(ρ ∨ σ), σ ⊢ σ
-----------------------ax     ---------------------Vi1              -----------------------ax     ----------------------Vi2     
¬(ρ ∨ σ), ρ ⊢ ¬(ρ ∨ σ)        ¬(ρ ∨ σ), ρ ⊢ (ρ ∨ σ)                 ¬(ρ ∨ σ), σ ⊢ ¬(ρ ∨ σ)        ¬(ρ ∨ σ), σ ⊢ (ρ ∨ σ)
----------------------------------------------------¬e              -----------------------------------------------¬e
¬(ρ ∨ σ), ρ ⊢ ⊥                                                     ¬(ρ ∨ σ), σ ⊢ ⊥
----------------¬i                                                  ----------------¬i
¬(ρ ∨ σ) ⊢ ¬ρ                                                       ¬(ρ ∨ σ) ⊢ ¬σ                
...
2)
                                                                    ---------------------------------ax                                    ---------------------------------ax
                                                                    (¬ρ ∧ ¬σ), (ρ ∨ σ), ρ ⊢ (¬ρ ∧ ¬σ)                                      (¬ρ ∧ ¬σ), (ρ ∨ σ), σ ⊢ (¬ρ ∧ ¬σ)
                                    -------------------------ax     ---------------------------------∧e1    -------------------------ax    ---------------------------------∧e2
                                    (¬ρ ∧ ¬σ), (ρ ∨ σ), ρ ⊢ ρ       (¬ρ ∧ ¬σ), (ρ ∨ σ), ρ ⊢ ¬ρ              (¬ρ ∧ ¬σ), (ρ ∨ σ), σ ⊢ σ      (¬ρ ∧ ¬σ), (ρ ∨ σ), σ ⊢ ¬σ
-----------------------------ax     ----------------------------------------------------------¬e            -------------------------------------------------------------------¬e
(¬ρ ∧ ¬σ), (ρ ∨ σ) ⊢ (ρ ∨ σ)        (¬ρ ∧ ¬σ), (ρ ∨ σ), ρ ⊢ ⊥                                               (¬ρ ∧ ¬σ), (ρ ∨ σ), σ ⊢ ⊥               
-------------------------------------------------------------------------------------------------------------------------------------Ve
(¬ρ ∧ ¬σ), (ρ ∨ σ) ⊢ ⊥ 
----------------------¬i
(¬ρ ∧ ¬σ) ⊢ ¬(ρ ∨ σ) 
